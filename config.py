...
class Config(object):
    ...
    BLOB_STORAGE_KEY = os.environ.get('BLOB_STORAGE_KEY') or '<YOUR_REAL_STORAGE_KEY>'
    ...
    SQL_PASSWORD = os.environ.get('SQL_PASSWORD') or '<YOUR_REAL_SQL_PASSWORD>'
    ...
    # -------- MICROSOFT AUTH --------
    CLIENT_ID = os.environ.get('CLIENT_ID') or '<YOUR_REAL_CLIENT_ID>'
    CLIENT_SECRET = os.environ.get('CLIENT_SECRET') or '<YOUR_REAL_CLIENT_SECRET>'
